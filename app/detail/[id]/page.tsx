...
const DetailPage = ({ params }: DetailPageProps) => {
  ...
  const videoData = {
    ...
    description: "A modern video player built with SwiftUI and AVKit",
    ...
    <div className="min-h-screen">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <Link href="/">
          <button
            onClick={copyCode}
            className="px-4 py-1 text-sm bg-white hover:bg-gray-50 text-gray-700 rounded-lg transition-colors duration-200 flex items-center border border-gray-200 cursor-pointer"
          >
            <svg
